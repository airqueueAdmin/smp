...
const ARCHETYPES = [
  {
    ...
    punchline: '싫다는 말도 못 하면서 남이 알아서 눈치채길 바라네. 그건 배려가 아니라 회피야.',
  ...
  },
  {
    ...
    punchline: '용감한 척하지만 사실 확인하기 귀찮아서 냅다 지르는 거잖아.',
  ...
  },
  {
    ...
    punchline: '신중한 게 아니라 실패가 무서워서 준비하는 척 미루는 중이야.',
  ...
  },
  {
    ...
    punchline: '긍정적인 게 아니라 귀찮은 현실을 웃음으로 덮고 튀는 데 능숙한 거야.',
  ...
  },
  {
    ...
    punchline: '책임감이 아니라 통제욕이야. 남 못 믿어서 다 떠안고 혼자 억울해하잖아.',
  ...
  },
  {
    ...
    punchline: '말만 번지르르해서 아직 시작도 안 한 일을 끝낸 것처럼 착각해.',
...
const FORTUNE_COPY: Record<FortuneKey, {
  ...
  wealth: {
    high: {
      ...
      factBomb: '버는 감각은 있는데 보상 소비로 다 새잖아. 많이 버는 척만 하지 마.',
      action: '안 쓰는 구독 하나 끊어.',
    },
    mid: {
      summary: '큰 한 방보다 익숙한 방식으로 안정적으로 쌓는 흐름이에요.',
      factBomb: '수입 탓하기 전에 매일 찍는 소액 결제부터 봐. 네가 꾸준히 새게 만들고 있어.',
      action: '이번 주 지출 한도부터 정해.',
    },
    low: {
      summary: '새 수익보다 새는 돈을 막는 것이 먼저인 시기예요.',
      factBomb: '재테크 영상만 보고 통장은 안 보지? 공부가 아니라 현실 도피야.',
  ...
  relationship: {
    high: {
      ...
      factBomb: '사람은 잘 모으는데 선을 못 그어서 남의 감정 쓰레기통을 자처해.',
      action: '답하기 싫은 연락은 씹어도 돼.',
    },
    mid: {
      summary: '먼저 마음을 건네면 관계의 온도가 빠르게 올라가는 흐름이에요.',
      factBomb: '말은 안 하고 알아주길 기다리다가 혼자 “나만 진심” 타령하잖아.',
      action: '보고 싶은 사람한테 먼저 연락해.',
    },
    low: {
      summary: '새 인연보다 기존 관계의 오해를 정리하는 일이 우선이에요.',
      factBomb: '거리 두는 척하지만 그냥 설명하기 귀찮아서 잠수 타는 거야.',
  ...
  achievement: {
    high: {
      ...
      factBomb: '능력은 있는데 욕심만 많아서 우선순위가 늘 세 개야. 그래서 셋 다 어중간해.',
      action: '이번 주 목표는 하나만 남겨.',
    },
    mid: {
      summary: '작은 완료를 연결할수록 큰 목표가 현실로 바뀌는 흐름이에요.',
      factBomb: '계획만 거창하게 잡고 부담스럽다며 내일로 미루는 게 네 패턴이야.',
      action: '30분짜리 첫 단계부터 끝내.',
    },
    low: {
      summary: '속도를 높이기보다 멈춘 이유부터 걷어내야 하는 시기예요.',
      factBomb: '시간 없는 게 아니야. 시작하기 싫어서 자잘한 일로 바쁜 척하는 거지.',
